...
export default function Work() {
  ...
  return (
    <section className="bg-[var(--bgcolor)] py-10 lg:py-20">
      <div className="container mx-auto px-4 md:px-12 lg:px-16">
        ...
        <div className="text-center mb-8 lg:mb-12">
          ...
          <h2 className="text-black text-3xl md:text-5xl lg:text-[60px] font-bold mb-6 lg:mb-8" style={{ fontFamily: '"Host Grotesk", sans-serif', padding: '20px 0px 0px', color: '#000000' }}>
            Smooth Start, Strong Growth
          </h2>
        </div>

        {/* Steps Navigation */}
        <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-8 lg:mb-12">
          {steps.map((step) => (
            <button
              key={step.step}
              onClick={() => {
              ...
              className={`px-4 md:px-10 lg:px-35 py-3 rounded-full font-semibold transition-all duration-300 cursor-pointer text-sm md:text-base ${
                activeStep === step.step
                  ? 'bg-black text-white'
                  : 'bg-[#ffffff38] text-black border border-white'
              }`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Left Side - Image */}
          <div className="relative smooth-img order-1 lg:order-none lg:col-span-8">
            <Image
              src={work}
              alt="Work Process"
              width={1000}
          ...
          {/* Right Side - Content */}
          <div className="flex flex-col order-2 lg:order-none lg:col-span-4 text-center lg:text-left">
            <h3 className="text-2xl md:text-4xl lg:text-5xl font-bold text-black mb-6 lg:mb-10" style={{ fontFamily: '"Host Grotesk", sans-serif', transition: '0.4s ease-in-out' }}>
              {currentStepData.heading}
            </h3>
            <p className="text-black text-base lg:text-lg leading-relaxed mb-4 lg:mb-6" style={{ fontFamily: '"Host Grotesk", sans-serif', transition: '0.4s ease-in-out' }}>
              {currentStepData.description}
            </p>
            <div className="h-px bg-gray-400 mb-4 lg:mb-6"></div>
