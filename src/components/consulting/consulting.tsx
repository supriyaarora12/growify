...
export default function Consulting() {
  ...
  return (
    <section id="about" className="relative min-h-screen flex items-center py-12 md:py-20 lg:py-30 scroll-mt-16">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-4 md:px-12 lg:px-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-1 items-end">
          ...
          <div className="text-white mt-16 md:mt-6 lg:mt-10">
            ...
            <p className="text-base md:text-lg lg:text-[22px] font-sans mt-6 lg:mt-10 text-[#C7C7C7] py-[10px] mb-6 lg:mb-[50px]">
              Our comprehensive office support services<br className="hidden lg:block" />
              <span className="lg:hidden"> </span>take care of everything from administrative tasks<br className="hidden lg:block" />
              <span className="lg:hidden"> </span>to technical troubleshooting.
            </p>
            ...
            <div className="mb-4">
              <div className="flex flex-col lg:flex-row items-start lg:items-start justify-between gap-4 lg:gap-0 mb-4 lg:-mb-18">
                {/* Profile Pictures */}
                <div className="flex">
                  <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-full border-4 border-black overflow-hidden relative z-[1]">
                    <Image src={li1} alt="Client 1" width={64} height={64} className="w-full h-full object-cover" />
                  </div>
                  <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-full border-4 border-black overflow-hidden -ml-4 relative z-[2]">
                    <Image src={li2} alt="Client 2" width={64} height={64} className="w-full h-full object-cover" />
                  </div>
                  <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-full border-4 border-black overflow-hidden -ml-4 relative z-[3]">
                    <Image src={li3} alt="Client 3" width={64} height={64} className="w-full h-full object-cover" />
                  </div>
                  <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-full border-4 border-black overflow-hidden -ml-4 relative z-[4]">
                    <Image src={li4} alt="Client 4" width={64} height={64} className="w-full h-full object-cover" />
                  </div>
                </div>
                
                {/* Google Rating Box */}
                <div className="goole-star bg-[#BEBEBE2B] text-[#212529] text-sm lg:text-base border-3 border-gray-400 font-sans pt-[20px] lg:pt-[25px] pr-[25px] lg:pr-[35px] pb-[12px] lg:pb-[17px] pl-[15px] lg:pl-[20px] flex flex-col items-start gap-2 lg:gap-3">
                  <FcGoogle className="w-8 h-8 lg:w-10 lg:h-10" />
                  <div className="flex items-start gap-1">
                    <FaStar className="text-yellow-400 w-3 h-3 lg:w-4 lg:h-4" />
                    <FaStar className="text-yellow-400 w-3 h-3 lg:w-4 lg:h-4" />
                    <FaStar className="text-yellow-400 w-3 h-3 lg:w-4 lg:h-4" />
                    <FaStar className="text-yellow-400 w-3 h-3 lg:w-4 lg:h-4" />
                    <FaStar className="text-yellow-400 w-3 h-3 lg:w-4 lg:h-4" />
                  </div>
                  <div className="text-gray-400 text-xs lg:text-sm gap-4 text-start">
              ...
              <p className="text-white text-base lg:text-lg">
                Our clients are ambitious businesses that  understand the<br className="hidden lg:block" />
                <span className="lg:hidden"> </span>value of efficiency.
              </p>
            </div>
          </div>
          ...
          {/* Right Section - Form */}
          <div 
            className="bg-[#8D8D8D5C] backdrop-blur-sm p-6 lg:p-15 shadow-2xl w-full lg:w-[98%] lg:max-w-[98%] lg:ml-auto form-clip-path"
            style={{
          ...
          >
            ...
            <form id="contact-form" onSubmit={handleSubmit} className="get-a-quote text-[#212529] text-base font-sans space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div>
                  <label className="block text-white text-sm font-bold mb-2">Phone No</label>
                  <input
                    type="tel"
                    name="phone"
                    ...
                    className="w-full bg-[#FBFBFB20] not-last-of-type:border border-gray-400 text-gray-300 rounded-xl px-4 py-4 focus:outline-none focus:ring-2 focus:ring-[var(--bgcolor)] placeholder:text-gray-300"
                  />
                </div>
                <div className="relative">
                  <label className="block text-white text-sm font-bold mb-2">Inquiry Type</label>
                  <div className="relative" ref={dropdownRef}>
                    <button
                      type="button"
                      onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                      className="w-full bg-[#FBFBFB20] border border-gray-400 text-[#ccc] rounded-xl px-4 py-4 focus:outline-none focus:ring-2 focus:ring-[var(--bgcolor)] appearance-none cursor-pointer text-left flex items-center justify-between placeholder:text-gray-300"
                    >
                      <span>
              ...
              <div>
                <label className="block text-white text-sm font-bold mb-2">Inquiry</label>
                <textarea
                  name="inquiry"
                  ...
                  rows={4}
                  className="w-full bg-[#FBFBFB20] border border-gray-400 text-white rounded-xl px-4 py-4 focus:outline-none focus:ring-2 focus:ring-[var(--bgcolor)] resize-none placeholder:text-gray-300"
                />
              </div>

              <div>
                <label className="block text-white text-sm font-bold mb-3">Role</label>
                <div className="flex flex-wrap lg:flex-nowrap gap-4">
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={handleChange}
                      className="mr-2 text-bgcolor accent-bgcolor"
                      style={{ width: '20px', height: '20px' }}
                    />
                    <span className="text-white font-bold">Owner/Partner</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
